    ...
    Card(
        ...
        Row(
            ...
            Column(
                ...
                Text(text = Submissions.divisionName, fontSize = 16.sp, color = Color.Black)

                Text(
                    text = Submissions.submissiontitle,
                    fontSize = 30.sp,
                ...
                Row(
                    ...
                    Text(text = Submissions.doctor, fontSize = 16.sp, color = Color.Black)
                }
            }
